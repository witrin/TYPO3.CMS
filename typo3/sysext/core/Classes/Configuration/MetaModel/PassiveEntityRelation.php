...
class PassiveEntityRelation implements Relational
{
    /**
     * @var IdentityPropertyDefinition
     */
    ...
    public function __construct(IdentityPropertyDefinition $propertyDefinition, PropertyDefinition $from)
    {
